...
with st.sidebar:
    ...
    income_growth = st.slider("What is your expected annual income growth rate in percentage?", min_value=0.0, max_value=100.0, value=10, step=0.1)
    ...
    inher_util = st.slider("What is your expected annual inheritance utilization?", min_value=0.0, max_value=100000.0, value=2000, step=0.1)
    save_rate = st.slider("What percent of your income do you expect to save annually?", min_value=0.0, max_value=100, value=5.0, step=0.1)
